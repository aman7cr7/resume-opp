...
const testimonials = [
    {
        name: 'Aman Singh Rana ',
        role: ' Web Developer',
        content:
            'Making a web Application is always fun and interesting and i m a web and android developer .',
        avatar:
            'https://avatars.githubusercontent.com/u/107622127?s=400&u=e95108d806750b66f9663944c972dee3ae5bc62d&v=4',
    }
];
...
export default function About() {
    return (
        <>
            <Helmet>
                <title>About Us - Resume Operator</title>
                ...
                <meta name="author" content="Aman Singh Rana" />
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content="About Us - Resume Operator" />
